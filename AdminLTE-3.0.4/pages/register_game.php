...
<head>
  ...
  <title>GameLive | Registration Page</title>
...
?>
  ...
  <div class="card">
    <div class="card-body register-card-body">
      <p class="login-box-msg">Add a new game to our database</p>
      ...
      <form action="../scripts/add_game.php" method="post">
        ...
        <div class="input-group mb-3">
          <textarea class="form-control" rows="3" placeholder="About your game" name='desc'></textarea>
          <div class="input-group-append">
            <div class="input-group-text">
